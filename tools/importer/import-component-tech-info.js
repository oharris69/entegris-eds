...
// PARSER IMPORTS (both reused — no new parsers)
...
const PAGE_TEMPLATE = {
  name: 'component-tech-info',
  description: 'Component Technical Information hub: title + intro prose, a featured-white-paper promo, and a 4-card sub-topic grid.',
  urls: ['https://www.entegris.com/en/home/resources/technical-information/component-technicalinformation.html'],
  blocks: [
  ...
  sections: [
    { id: 'cti-main', name: 'Intro + featured white paper', selector: '#maincontent > div.one-column-page', style: null, blocks: ['teaser-promo'], defaultContent: ['#maincontent > div.one-column-page'] },
    { id: 'cti-grid', name: 'Sub-topic grid', selector: '.pagelist .plp-container', style: null, blocks: ['cards-products'], defaultContent: [] },
  ],
};
